...
$(document).ready(function() { 
	$('#patterns div').click(function() {
		...
		if ($(this).attr('id') == 'pat_1') {
			$('#body_pat').css('background-image', 'url(img/patterns/pattern_1.png)');
		};
		if ($(this).attr('id') == 'pat_2') {
			$('#body_pat').css('background-image', 'url(img/patterns/pattern_2.png)');
		};
		if ($(this).attr('id') == 'pat_3') {
			$('#body_pat').css('background-image', 'url(img/patterns/pattern_3.png)');
		};
		if ($(this).attr('id') == 'pat_4') {
			$('#body_pat').css('background-image', 'url(img/patterns/pattern_4.png)');
		};
		if ($(this).attr('id') == 'pat_5') {
			$('#body_pat').css('background-image', 'url(img/patterns/pattern_5.png)');
		};
